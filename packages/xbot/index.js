...
var XBot = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(i < this.apiList.length)) return [3 /*break*/, 6];
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
...
export default XBot;
var NotImplementedInApiError = /** @class */ (function (_super) {
...
export { Location };
var MessengerSpecific = /** @class */ (function () {
    function MessengerSpecific(type, data) {
        this.type = type;
        this.data = data;
    }
    return MessengerSpecific;
}());
export { MessengerSpecific };
...
var File = /** @class */ (function (_super) {
    ...
    File.fromBuffer = function (buffer, name, mime) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, new File(createReadStream(buffer), buffer.length, name, mime)];
            });
        });
    };
    File.fromUrl = function (url, name, mime) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, emit("GET " + url + " STREAM")];
                    case 1:
                        res = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        size = (_a.sent()).size;
                        return [2 /*return*/, new File(getReadStream(path), size, name, mime)];
                }
            });
        });
    };
...
var Image = /** @class */ (function (_super) {
    ...
    Image.fromUrl = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, emit("GET " + url)];
                    case 1:
                        res = _a.sent();
                        size = parseInt(res.headers['content-length'], 10);
                        return [2 /*return*/, new Image(createReadStream(res.raw), size)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        size = (_a.sent()).size;
                        return [2 /*return*/, new Image(getReadStream(path), size)];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, readStream(fullStream)];
                    case 1:
                        buffer = _a.sent();
                        return [2 /*return*/, new Image(createReadStream(buffer), buffer.length)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        size = (_a.sent()).size;
                        return [2 /*return*/, new Audio(getReadStream(path), size, artist, title)];
                }
            });
        });
    };
...
var ForwardedMessage = /** @class */ (function () {
...
var MessageEvent = /** @class */ (function (_super) {
    ...
    function MessageEvent(data) {
        ...
        _this.timing = data.timing || new TimingData();
...
export { LeaveEvent };
var TitleChangeEvent = /** @class */ (function () {
...
export { TitleChangeEvent };
var PhotoChangeEvent = /** @class */ (function () {
