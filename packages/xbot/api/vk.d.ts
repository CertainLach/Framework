...
export default class VKApi extends Api {
    ...
    uploadToken: string;
    constructor();
    auth(tokens: string[]): Promise<void>;
    execute(method: string, params?: {}): Promise<any>;
    tokenId: number;
    executeMulti(tasks: Array<[string, any]>): Promise<any[]>;
    ...
    parseAttachment(attachment: any): Promise<Image>;
