...
var VKApi = /** @class */ (function (_super) {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, asyncEach(curDep, function (cur) { return __awaiter(_this, void 0, void 0, function () {
                                                var res;
                                                return __generator(this, function (_a) {
                                    ...
                                    case 1:
                                        ...
                                        if (!(Array.from(curDep).length != 0)) return [3 /*break*/, 4];
                                    ...
                                    case 2:
                                        res = _a.sent();
                                        return [4 /*yield*/, asyncEach(res, function (r) { return __awaiter(_this, void 0, void 0, function () {
                                                return __generator(this, function (_a) {
    ...
    VKApi.prototype.getChat = function (chat) {
        return __awaiter(this, void 0, void 0, function () {
            var key, res, data, chatConv, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 4:
                        chatConv = new (_a.apply(Chat, [void 0, (_b.admins = [_c.sent()],
                                _b.photoUrl = data.photo_200,
                                _b)]))();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, Image.fromUrl(attachment.photo['photo_' + max[max.length - 1]])];
                    case 2:
                        result = _b.sent();
                        return [3 /*break*/, 8];
                    case 3: return [4 /*yield*/, File.fromUrl(attachment.doc.url, attachment.doc.title)];
                    case 4:
                        result = _b.sent();
                        return [3 /*break*/, 8];
                    case 5: 
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, emit("GET https://" + server, {
                                query: {
                                    act: 'a_check',
                                    key: key,
                                    ts: ts,
                    ...
                    case 1:
                        ...
                        result.updates.forEach(function (update) { return __awaiter(_this, void 0, void 0, function () {
                            var that, type, _a, flags, user_id, from_id, timestamp, subject, text, attachments, chat_id, message_id, peer_id, local_id, count, extra, mask, _b, user_1, user_2, _c, user_3, chat_1, timing, event, user_4, chat_2, initiator, initiatorP, userP, chatP, _d, _e, _f, realMessageNeeded, realMessage, forwarded, attachment, fwd, _g, _h, _j, _k, lat, long, sender_id, isChat, user_5, message, _l, _m, _o, e_4, _p, _q;
                            return __generator(this, function (_r) {
                                switch (_r.label) {
                                    ...
                                    case 10:
                                        _c = _r.sent(), user_3 = _c[0], chat_1 = _c[1];
                                        this.emit('action', new ActionEvent({
                                            user: user_3,
                                            chat: chat_1,
                                            action: 'writing',
                                    ...
                                    case 11:
                                        ...
                                        if (!attachments.source_act) return [3 /*break*/, 21];
                                        ...
                                        return [3 /*break*/, 19];
                                    case 12:
                                        _e = TitleChangeEvent.bind;
                                        _f = { oldTitle: attachments.source_old_text, newTitle: attachments.source_text };
                                        return [4 /*yield*/, this.getUser(attachments.from)];
                                    case 13:
                                        _f.initiator = _r.sent();
                                        return [4 /*yield*/, this.getChat(from_id - 2e9)];
                                    case 14:
                                        event = new (_e.apply(TitleChangeEvent, [void 0, (_f.chat = _r.sent(), _f)]))();
                                    ...
                                    case 16:
                                        _p = _r.sent(), user_4 = _p[0], chat_2 = _p[1], initiator = _p[2];
                                        event = new JoinEvent({ user: user_4, chat: chat_2, initiator: initiator });
                                    ...
                                    case 17:
                                        ...
                                        return [4 /*yield*/, Promise.all([userP, chatP, initiatorP])];
                                    case 18:
                                        _q = _r.sent(), user_4 = _q[0], chat_2 = _q[1], initiator = _q[2];
                                        event = new LeaveEvent({ user: user_4, chat: chat_2, initiator: initiator });
                                    ...
                                    case 24:
                                        _h.sender = _r.sent();
                                        if (!fwd.attachments) return [3 /*break*/, 26];
                                    ...
                                    case 26:
                                        ...
                                        _r.label = 27;
                                    case 27:
                                        forwarded = new (_g.apply(ForwardedMessage, [void 0, (_h.attachment = _j,
                                                _h)]))();
                                        timing.stop();
                                        _r.label = 28;
                                    case 28:
                                        if (!attachments.geo) return [3 /*break*/, 29];
                                        timing.start('GeoDB');
                                        _k = realMessage.geo.coordinates.split(' '), lat = _k[0], long = _k[1];
                                        attachment = new Location(lat, long);
                                        timing.stop();
                                        return [3 /*break*/, 31];
                                    case 29:
                                        if (!(realMessage && realMessage.attachments)) return [3 /*break*/, 31];
                                    ...
                                    case 34:
                                        ...
                                        _r.label = 35;
                                    case 35:
                                        message = new (_l.apply(MessageEvent, [void 0, (_m.chat = _o,
                                                _m.replyTo = forwarded,
                                                _m.messageId = message_id,
                                                _m.timing = timing,
                                                _m)]))();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        server = _a.sent();
                        return [4 /*yield*/, emit("POST " + server.upload_url, {
                                multipart: true,
                                timeout: 50000,
                                data: {
    ...
    VKApi.prototype.sendCustom = function (targetId, answer, caption, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!options.ytVideo) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.execute('video.save', {
                                link: options.ytVideo
                            })];
                    case 1:
                        res1 = _a.sent();
                        return [4 /*yield*/, emit('POST ' + res1.upload_url)];
                    case 2:
                        res2 = _a.sent();
