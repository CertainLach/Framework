...
import { PotatoSocketUniversal, WebSocketClient } from '../';
/**
 * Websocket potato.socket client
 */
var PotatoSocketClient = /** @class */ (function (_super) {
    ...
    function PotatoSocketClient(name, encoder, websocketAddress, reconnectInterval) {
        ...
        _this.websocket = new WebSocketClient(_this.websocketAddress, reconnectInterval);
...
export default PotatoSocketClient;
