...
var POSSIBLE_EVENTS = METHODS.slice();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(decoder in decoders)) return [3 /*break*/, 2];
    ...
    Request.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.options.multipart) return [3 /*break*/, 2];
...
export function emit(eventString, options) {
    ...
    return new Promise(function (res, rej) {
        request.run();
        request.on('timeout', function (ms) { return __awaiter(_this, void 0, void 0, function () {
            var data, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        logger.warn('Timeout, repeat in 15 s');
                        return [4 /*yield*/, new Promise(function (res) { return setTimeout(res, 150000); })];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, emit(eventString, options)];
                    case 3:
                        data = _a.sent();
                        res(data);
                        return [3 /*break*/, 5];
