...
export default class State {
     ...
     */
    translate(request: Request, targetVector: Vector, noCache?: boolean): any;
    /**
     ...
     * @param getIndex
     */
    requestByUser(user: number, getIndex: number): RedoRequest | DoRequest | UndoRequest;
    /**
     * Retrieve the first request in the log that was issued by the given user
     * @param user
     */
    firstRequestByUser(user: number): RedoRequest | DoRequest | UndoRequest;
}
