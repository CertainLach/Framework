...
(function (dependencies, factory) {
...
})(["require", "exports", "@meteor-it/logger", "@meteor-it/fs", "@meteor-it/utils", "@meteor-it/queue", "path", "chokidar"], function (require, exports) {
    "use strict";
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, fs_1.readDir(this.folder)];
                        case 1:
                            files = _a.sent();
                            ...
                            return [4 /*yield*/, utils_1.asyncEach(plugins, function (plugin) {
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            // if (!plugins)
                                            //     this.logger.error('');
                                            return [4 /*yield*/, utils_1.asyncEach(plugins, function (plugin) { return __awaiter(_this, void 0, void 0, function () {
                                                    var _this = this;
                                                    return __generator(this, function (_a) {
                                                        switch (_a.label) {
                                                            case 0:
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            plugins_1 = files.map(function (file) {
                                try {
                                    _this.logger.log('Loading {magenta}%s{/magenta}', file);
                                    return _this.loadPlugin(path_1.resolve(_this.folder, file));
                                }
                                catch (e) {
                            ...
                            this.logger.deent();
                            this.logger.ident('Validating and displaying copyrights');
                            return [4 /*yield*/, utils_1.asyncEach(plugins_1, function (plugin) {
                                    try {
    ...
    var WebpackPluginLoader = (function () {
