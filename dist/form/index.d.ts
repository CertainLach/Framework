...
export default class FormValidator {
    ...
    static text(placeholder: any, [min, max]: [any, any], regex?: any, defaultValue?: string): TextFieldData;
    static number(placeholder: any, [min, max]: [any, any], defaultValue?: number): NumberData;
    static select(placeholder: any, possible: any, defaultValue?: any): SelectData;
    static multi(placeholder: any, [min, max]: [any, any], inner: any): MultiFieldData;
    validate(data: any): ValidationError | true;
    getDefaultValue(): any;
}
export declare function stringifyError(error: ValidationError, returnKey: any): string;
