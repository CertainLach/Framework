(function (dependencies, factory) {
...
})(["require", "exports", "../SegmentBuffer", "./Split", "./NoOp", "./Insert", "../Recon", "../ReconSegment"], function (require, exports) {
    "use strict";
    var SegmentBuffer_1 = require("../SegmentBuffer");
    var Split_1 = require("./Split");
    var NoOp_1 = require("./NoOp");
    var Insert_1 = require("./Insert");
    var Recon_1 = require("../Recon");
    ...
    var Delete = (function () {
        ...
        function Delete(position, what, recon) {
            if (recon === void 0) { recon = new Recon_1.default(); }
        ...
        Delete.prototype.split = function (at) {
            if (this.isReversible()) {
                ...
                // components.
                var recon1 = new Recon_1.default();
                var recon2 = new Recon_1.default();
        ...
        Delete.prototype.transform = function (other, cid) {
            ...
            if (other instanceof Insert_1.default) {
                ...
                if (pos2 <= pos1 && pos2 + len2 >= pos1 + len1) {
                     ...
                     */
                    var newData = (this.isReversible() ? new SegmentBuffer_1.default() : 0);
