...
(function (dependencies, factory) {
...
})(["require", "exports", "@meteor-it/utils", "@meteor-it/logger", "path"], function (require, exports) {
    "use strict";
    ...
    var ArgParser = (function () {
        ...
        ArgParser.prototype.print = function (str, code) {
            var _this = this;
            str.split('\n').forEach(function (s) { return _this.logger.log(s); });
            process.exit(code || 0);
        };
        ArgParser.prototype.parse = function (argv) {
            ...
            var commandExpected = this.commands.length !== 0;
            if (commandExpected) {
                if (command) {
                    ...
                    var helpStringBuilder = {
                        ...
                        twoColumn: function () {
                            ...
                            var cmdHelp = utils_1.objectMap(this.commands, function (cmd, name) {
            ...
            if (this.specs.length === undefined) {
                ...
                this.specs = utils_1.objectMap(this.specs, function (opt, name) {
                    opt.name = name;
                    return opt;
                });
            }
