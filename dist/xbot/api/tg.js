...
})(["require", "exports", "../", "node-telegram-bot-api"], function (require, exports) {
    "use strict";
    var _1 = require("../");
    var node_telegram_bot_api_1 = require("node-telegram-bot-api");
    var TGApi = (function (_super) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_h) {
                    switch (_h.label) {
                        ...
                        case 4:
                            _f = (_e = _1.File).fromUrl;
                            return [4 /*yield*/, this.bot.getFileLink(obj.file_id)];
                        case 5: return [4 /*yield*/, _f.apply(_e, [_h.sent(), obj.file_name])];
                        case 6: return [2 /*return*/, _h.sent()];
                        case 7: return [2 /*return*/, new _1.Location(obj.latitude, obj.longitude)];
                        case 8:
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            _a.label = 3;
                        case 3: return [2 /*return*/, new _1.User({
                                messageId: null,
                                api: this,
                                uid: 'TG.' + data.id,
                                targetId: data.id,
